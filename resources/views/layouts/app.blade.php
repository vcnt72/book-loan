          ...
          <div class="col">
            <div class="row">
              <div class="col footer-human-info">
                <img
                  src="{{asset('images/phoneNumber.png')}}"
                  class="footer-logo"
                  alt=""
                />
            ...
            <div class="row">
              <div class="col footer-human-info">
                <img
                  src="{{asset('images/black-email-logo.png')}}"
                  alt=""
                  class="footer-logo"
                />
          ...
          <div class="col">
            <div class="row">
              <div class="col footer-socmed-container">
                <img
                  src="{{asset('images/f_logo_RGB-Hex-Blue_512.png')}}"
                  class="footer-logo"
                  alt="facebook logo"
                />
                <div>Facebook</div>
              ...
              <div class="col footer-socmed-container">
                <img
                  src="{{asset('images/1024px-Instagram_logo_2016.svg.png')}}"
                  alt="instagram logo"
                  class="footer-logo"
                />
                <div>Instagram</div>
              ...
              <div class="col footer-socmed-container">
                <img
                  src="{{asset('images/Twitter_bird_logo_2012.svg.png')}}"
                  alt=""
                  class="footer-logo"
                />
